...
public class ShowTimeService {
    ...
    public ShowTimeService(
            ...
            RoomRepository roomRepository, CinemasService cinemasService) {
    ...
    public List<ShowTimeResponse> getAllShowTimesByRoomId(long roomId) {
        List<ShowTime> showTimes = showTimeRepository.findAllByRoomId(roomId);
        return showTimes.stream().map(showtime -> convertToShowTimeResponse(showtime)).collect(Collectors.toList());
    }
    ...
    public List<ShowTimeResponse> getAllShowTimes(){
        List<ShowTime> showTimeResponseList = showTimeRepository.findAll();
        return showTimeResponseList.stream().map(showTimes -> convertToShowTimeResponse(showTimes)).collect(Collectors.toList());
    }
